...
public class Solution
{
    public static void main(String[] args) throws IOException
    {
        ...
        {
            String s = list.get(i);
            String d=list.get(i)+" "+list.get(i);
            String t=list.get(i)+" "+list.get(i)+" "+list.get(i);
            if (s.length()%2==0) {list.add(i,d);list.remove(i+1);}
                if (s.length()%2!=0){list.add(i,t);list.remove(i+1);}
        }
